define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'userloginlog/index' + location.search,
                    add_url: 'userloginlog/add',
                    edit_url: 'userloginlog/edit',
                    del_url: 'userloginlog/del',
                    multi_url: 'userloginlog/multi',
                    import_url: 'userloginlog/import',
                    table: 'userloginlog',
                }
            });
